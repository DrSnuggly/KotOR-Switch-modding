...
import type { AnyCommand } from "~/main"
...
export class Config {
  ...
  constructor(command: AnyCommand, configFile: string) {
    // very bare-bones constructor since this is initialized in the main
    // command, not any of the subcommands where the rest of the config is
    // available
